void grid_draw_rotate_225()
{
  ...
  final int const_grid_offset_y = const_screen_y_end - const_font_height_d_2 + (DRAW_OFFSET_Y[0] % 100);
  ...
  //final int const_str_base_ix_y = const_screen_y_end + DRAW_OFFSET_Y[0];
  final int const_str_base_ix_y =
    (DRAW_OFFSET_Y[0] < const_screen_y_start - const_screen_y_end)
    ?
    ...
    ((DRAW_OFFSET_Y[0] > 0)
      ...
      const_screen_y_end
      :
      (const_screen_y_end + DRAW_OFFSET_Y[0])
    );
